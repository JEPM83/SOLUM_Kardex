...
values('20100310288','SAP_SEND_KARDEX',1,6,30,1,1,1,1,1,1,1,0,0,1,NULL,NULL,0)
...
END
go
create PROCEDURE [dbo].[BZ_JEPM_UltimoProceso_Planificado](@Code int,@Auditoria datetime,@Mensaje nvarchar(max) = NULL,@Hostgroupid varchar(25))
AS
BEGIN
	UPDATE [@EX_PLANIFICADO] SET [ultimoproceso] = @Auditoria,mensaje = @Mensaje,hostgroupid = @Hostgroupid WHERE Code = @Code
END
Go
...
--EXEC SBO_SOLUM_BC.DBO.SC_KardexMovimientos 'C20100310288','2024-02-13','2024-02-13'
...
UPDATE [@EX_PLANIFICADO] SET hora = 11,minuto=45 WHERE CODE = 1
UPDATE [@EX_PLANIFICADO] SET fechainicio = '2024-02-09',fechafin='2024-02-09' WHERE CODE = 1
